...
default['etherpad-lite']['db_server'] = false
default['etherpad-lite']['db_type'] = 'mysql'
default['etherpad-lite']['db_user'] = 'etherpad'
default['etherpad-lite']['db_host'] = 'localhost'
default['etherpad-lite']['db_password'] = 'changeMyPassword'
...
default['etherpad-lite']['service_uid'] = 500
default['etherpad-lite']['service_gid'] = 500
default['etherpad-lite']['service_user_home'] = '/var/etherpad'
default['etherpad-lite']['logs_dir'] = '/var/logs/etherpad'
default['etherpad-lite']['domain'] = ''
